...
_The SANOVIO Team has identified the need to create and organize new requests for procurement. If users want to buy a product or service they need to create a formal request to the procurement department. That will afterwards process this request_
...
Set the OPENAI_API_KEY environment variable or add it to backend/.env. Do not commit real API keys.
